...
def build_bridge_for_hf_checkpoint(hf_checkpoint: str, *, load_weights: bool):
    ...
    qwen35_text_family = {"qwen3_5", "qwen3_5_text", "qwen3_5_moe", "qwen3_5_moe_text"}
    if _use_text_only_qwen35_bridge() and model_type in qwen35_text_family:
        from megatron.bridge.models.hf_pretrained.causal_lm import PreTrainedCausalLM
        from slime_plugins.megatron_bridge.qwen3_5_text import MegatronQwen35TextBridge

        bridge = MegatronQwen35TextBridge()
    ...
    auto_bridge = patch_auto_bridge_hf_config(AutoBridge.from_hf_pretrained(hf_checkpoint, trust_remote_code=True))
